...
public class GerarFechamento {
	...
	public static void main(String[] args) throws IOException, LotoException {
		...
		String[] str = { "1","3","4","5","6","8","9","10","13","14","15","17","18","20","21","22","23","25" };
		
		FileWriter arq = new FileWriter("D:\\projetos_loto\\18_25\\facil-core\\src\\main\\resources\\fechamento\\jogo\\GerarFechamento2097.csv");
