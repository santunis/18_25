...
public class RetirarNumerosJaSaiu {

	@SuppressWarnings({ "deprecation" })
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {

		FileWriter arqSaiu = new FileWriter("D:\\projetos_loto\\18_25\\facil-core\\src\\main\\resources\\dezoito\\fechamento\\Fechamento15_25_QUATORZE_NAOSAIU.csv");
		PrintWriter gravarArq = new PrintWriter(arqSaiu);

		int cont = 0;
		URL resultado = RetirarNumerosJaSaiu.class.getClassLoader().getResource("dezoito\\fechamento\\Fechamento15_25_QUATORZE.csv");
