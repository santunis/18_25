...
public class Resultado1825MAISSAIU {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {
		...
		FileWriter arqSaiu = new FileWriter("D:\\projetos_loto\\18_25\\facil-core\\src\\main\\resources\\Resultado1825MAISSAIU.csv");
	...
	public static int Resultado1825SAIU(int[] linhaCombinacao1825) throws URISyntaxException, NumberFormatException, IOException {
		...
		int contJogo = 0;
		int qtdJogoSaiu = 0;
		URL resultado1825SAIU = Resultado1825MAISSAIU.class.getClassLoader().getResource("Resultado1825SAIU.csv");
		if (Objects.nonNull(resultado1825SAIU)) {
			...
			while (Objects.nonNull((linhaResultado1825SAIU = csvReader.readNext()))) {
				...
				if (contJogo == NumeroEnum.DEZOITO.getValor()) {
					qtdJogoSaiu++;
				}
			}
		} else {
