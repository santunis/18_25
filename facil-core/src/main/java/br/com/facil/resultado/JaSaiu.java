...
public class JaSaiu {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {
		...
		int[] jogo = { 2,3,5,6,9,10,11,13,14,16,18,20,23,24,25 };
		...
		URL combinacoes = JaSaiu.class.getClassLoader().getResource("dezoito\\fechamento\\Fechamento15_25_QUATORZE.csv");
